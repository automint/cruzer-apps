...
public class Vehicle extends Fragment {
    ...
    private CardView cardVehicleName, cardCompany, cardModel;
    ...
    private void initializeViews(View v) {
        ...
        cardVehicleName = (CardView) v.findViewById(R.id.card_vehicle_name);
        cardCompany = (CardView) v.findViewById(R.id.card_vehicle_company);
        cardModel = (CardView) v.findViewById(R.id.card_vehicle_model);
    }
    ...
    private void setContent() {
        ...
        cardVehicleName.setVisibility((vehicle.name == null || vehicle.name.isEmpty()) ? View.GONE : View.VISIBLE);
    }
}
